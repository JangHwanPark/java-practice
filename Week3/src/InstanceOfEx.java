...
class UpCastingTest extends Person {}
...
public class InstanceOfEx {
    public static void print(Person p) {
        ...
        if (p instanceof UpCastingTest) System.out.println("UpCastingTest");
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.print("new UpCastingTest()->\t"); print(new UpCastingTest());
    }
}
